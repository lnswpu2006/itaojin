...
class ReadCaseExcel:
    ...
    def __init__(self):
        global case
        try:
            self.data = xlrd.open_workbook(globalparam.data_path.scan_files(postfix='case.xls'))
...
class ReadStepExcel:
    ...
    def __init__(self):
        global case
        try:
            self.data = xlrd.open_workbook(globalparam.data_path.scan_files(postfix='step.xls'))
